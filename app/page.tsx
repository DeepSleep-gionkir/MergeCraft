...
export default function Home() {
  ...
  return (
    <main className="flex flex-col md:flex-row h-[100dvh] w-screen overflow-hidden bg-black">
      ...
      <div className="order-2 md:order-1 flex-[0.4] md:flex-none md:h-full w-full md:w-[340px] shrink-0 z-20 shadow-2xl md:shadow-none min-h-0">
        <Inventory />
      </div>
      
      {/* Workspace: Mobile Top (Flex), Desktop Right (Rest) */}
      <div className="order-1 md:order-2 flex-[0.6] md:flex-1 flex flex-col md:h-full relative z-10 min-h-0">
